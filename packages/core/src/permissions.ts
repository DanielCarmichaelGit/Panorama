...
export const HUMAN_ACTIONS = ["project.create", "board.create", "agent.approve", "agent.revoke", "ticket.archive", "flag.clear_needs_human", "checkpoint.create", "lock", "lane.edit", "evidence.signoff", "epic.edit", "tag.edit", "field.edit", "criteria.edit", "evidence.edit"] as const;
