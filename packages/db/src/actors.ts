...
export const setCurrentTicket = (db: DB, actorId: string, ticketId: string | null): void => { db.prepare("update actors set current_ticket_id = ? where id = ?").run(ticketId, actorId); };
