...
- [ ] Multi-user accounts, roles, and permissions (v1 is one human plus agent keys)
- [ ] Hosted cloud version
- [ ] Billing (only relevant to a hosted version; the self-hosted product stays free)
- [ ] Opt-in, privacy-respecting telemetry
- [ ] Built-in LLM calls (for example summarising a thread); v1 makes none by design
- [ ] Mobile app
